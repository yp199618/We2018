        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
          	<form action="" method="post">
          		<a href="${pageContext.request.contextPath}/user/password">修改密码</a>
          		<table class="table table-bordered table-hover suppplier_table">
          			<c:if test="${seller.seller_id != null && seller.seller_id != ''}">
          				<tr>
	          				<td>图片</td>
	          				<td>
	          					<img alt="" src="${pageContext.request.contextPath}/we_file/${seller.seller_img}" class="photo">
								<input type="text" value="${seller.seller_id}"  hidden="true">
          			...
          			<tr>
          				<td>姓名</td>
          				<td>
          					<input type="text" name="seller_real_name" value="${seller.seller_real_name}">
          					<input type="text" name="seller_id" value="${seller.seller_id}" hidden="hidden" id="seller_id">
          				</td>
          			</tr>
          			<tr>
          				<td>手机号</td>
          				<td><input type="text" name="seller_phone" value="${seller.seller_phone}"></td>
          			</tr>
          			<tr>
          				<td>支付宝</td>
          				<td><input type="text" name="seller_epay" value="${seller.seller_epay}"></td>
          			</tr>
          			
          			<tr>
          				<td colspan="2">
          				<c:if test="${seller.seller_id != null}">
          					<button type="submit" class="btn btn-default" formaction="${pageContext.request.contextPath}/user/update">修改</button>
          				</c:if>
